...
static void draw(const double xmin, const double xmax, const double ymin, const double ymax, const int maxIter) {
    ...
    wchar_t title[1024]{};
    std::string debugInfo = "PhysY 0.2.0 Debug (" + debuginfo(xmin, xmax, ymin, ymax, maxIter) + ")";
...
int main() {
    ...
    double xmin = -2.5;
    double xmax = 0.1; // 0.0 won't let you zoom out, plus it's no actual point to keep it like that
    double ymin = -1.5;
    double ymax = 0.1; // same
    int maxIter = 1000;
